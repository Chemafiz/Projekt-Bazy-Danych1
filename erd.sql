...
BEGIN
  RETURN QUERY
    ...
    where nr_linii = lin
    group by (nr_linii,numer_przejazdu, nazwa, na_zadanie, godzina_przyjazd, godzina_odjazd);
END;
$$
LANGUAGE 'plpgsql';
...
CREATE OR REPLACE FUNCTION polacz_dane(id_kier int, id_auto int, nr_lin int, nr_godziny int)
returns void as
$$
BEGIN
    UPDATE autobus
...
INSERT INTO przystanek(nazwa) VALUES
 ...
 INSERT INTO kierowca (nazwisko, imie) VALUES
 ('Banan', 'Łukasz'),
  ('Pietruszka', 'Wojciech'),
 ('Ogórek', 'Magdalena'),
 ('Seler', 'Krystian'),
 ...
 INSERT INTO autobus (typ_autobusu, liczba_miejsc) VALUES
 ('duży', 50),
  ('duży', 55),
 ('duży', 45),
 ('średni', 25),
