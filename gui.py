        ...
        while True:
            ...
            if event in ["laczenie_pokaz", "laczenie_zapisz", "polaczane_dane_wyswietl"]:              # laczenie danych
                ...
                if event == "laczenie_zapisz":
                    polacz_dane(values["laczenie_kierowca"], values["laczenie_autobus"], values["laczenie_linia"], cursor, conn)
                    sg.popup('Zapisano dane!!!')
            ...
            if event in ["wyswietl_linie", "dodaj_zapisz"]:              # dodawanie godzin
                if event == "wyswietl_linie":
                    ...
                    numer_przejazdu = ostatni_numer_przejazdu(values["numer_linia"], cursor)
                    last_id_polaczenie = get_pierwszy_id_przyjazd(values["numer_linia"], cursor)
